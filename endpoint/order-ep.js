...
exports.assignDriverOrder = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const assignmentCheck = await orderDao.CheckOrderAlreadyAssigned(orderId, driverId);
        ...
        const result = await orderDao.SaveDriverOrder(driverId, orderId, handOverTime);
